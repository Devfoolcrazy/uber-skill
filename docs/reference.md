# Uber Skill : référence

Documentation détaillée du fonctionnement. Pour la présentation et la prise en main, voir le [README](../README.md) ; le mode d’emploi embarqué dans l’application est dans [`apps/desktop/src/lib/guide.md`](../apps/desktop/src/lib/guide.md).
